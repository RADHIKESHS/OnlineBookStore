package com.offline.BookStoreManagement.config;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.sessionManagement(se -> se.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/auth/profile", "/api/auth/updateProfile","/api/auth/logout").hasAnyRole("USER", "ADMIN")  // Accessible by USER and ADMIN
                .requestMatchers("/api/auth/orders").hasRole("USER") 
                .requestMatchers("/api/books/**", "/api/admin/**").hasRole("ADMIN")
